...
COMMENT ON COLUMN posts.image_url IS 'URL of the generated image (if uploaded to storage)';
COMMENT ON COLUMN posts.image_data IS 'Base64-encoded image data from Gemini';
